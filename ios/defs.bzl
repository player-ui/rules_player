...
load("//ios/private:zip.bzl", _assemble_ios_release = "assemble_ios_release", _assemble_pod = "assemble_pod")

assemble_ios_release = _assemble_ios_release
assemble_pod = _assemble_pod  # Deprecated - use assemble_ios_release instead
