...
def compile_mocks(mock_dirs, dsl_config, data, cli = "@player-tools/cli", dsl_package = "@player-tools/dsl", name = "mocks"):
    ...
    Args:
        ...
        dsl_package: Player DSL package used for content
    """
