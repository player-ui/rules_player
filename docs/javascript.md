...
js_pipeline(<a href="#js_pipeline-package_name">package_name</a>, <a href="#js_pipeline-name">name</a>, <a href="#js_pipeline-srcs">srcs</a>, <a href="#js_pipeline-package_json">package_json</a>, <a href="#js_pipeline-root_package_json">root_package_json</a>, <a href="#js_pipeline-vitest_config">vitest_config</a>, <a href="#js_pipeline-tsup_config">tsup_config</a>,
            ...
            <a href="#js_pipeline-benchmark_envs">benchmark_envs</a>, <a href="#js_pipeline-xlr_bundle_target">xlr_bundle_target</a>, <a href="#js_pipeline-_extra_replace_prefixes">_extra_replace_prefixes</a>)
</pre>
...
| <a id="js_pipeline-xlr_bundle_target"></a>xlr_bundle_target |  Optional label of an `xlr_bundle` target (see `player/private/xlr_bundle.bzl`) whose collated manifest should be added to this package and relocated into the published `dist/xlr/` layout. Assumes `xlr_bundle`'s default `output_dir` ("xlr_bundle_out").   |  `None` |
